        ...
        child: Stack(
          ...
          children: <Widget>[
            Transform.scale(
              ...
              child: Opacity(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(unslectedIcon, size: iconSize, color: inactiveColor),
                    Text(
                      text,
            ...
            Transform.scale(
              ...
              child: Opacity(
                opacity:
                    controller.value > 0.6 && seletedIndex == index ? 1.0 : 0.0,
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
              ...
              // child: ClipOval(
              //   // clipper: IconClipper(radius: _clipRadius()),
              //   child: ,
              // ),
            ),
          ],
